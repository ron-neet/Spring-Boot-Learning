...
import com.ronitCodes.crudDemo.entity.*;
...
public class CrudDemoApplication {
	...
	public CommandLineRunner commandLineRunner(AppDAO appDAO) {
		...
		return runner -> {
				...
				// findCoursesWithStudents(appDAO);
				// findStudentWithCourses(appDAO);
				// addMoreCoursesForStudent(appDAO);
				// deleteCourse(appDAO);
				deleteStudentWithoutCourse(appDAO);
		};
	}

	private void deleteStudentWithoutCourse(AppDAO appDAO){
		int theId = 1;
	...
	private void addMoreCoursesForStudent(AppDAO appDAO){
		...
		// Create more courses
		Course tempCourse1 = new Course("Github");
		Course tempCourse2 = new Course("MySQL");
	...
	private void findStudentWithCourses(AppDAO appDAO){
		...
		int theId = 1;
		System.out.println("The student id: "+ theId);
	...
	private void findCoursesWithStudents(AppDAO appDAO){
		int theId = 11;

		System.out.println("The Course if: "+ theId);
...
private void createCourseAndStudents(AppDAO appDAO){
	...
	// Create Student
	Student tempStudent1 = new Student("Ronit", "Codes", "ronitStha17@gmail.com");
	Student tempStudent2 = new Student("Legato", "Codez", "LegatoStha27@gmail.com");
